...
const CONFIG = {
  /* Fondo */
  framesPath: "/frames/frame_", totalFrames: 150, fps: 24, pad: 3,
...
/* ---- Normaliza basenames / typos ---- */
const ASSETS_BASE_A = "/fotoscatalogoweb/";
const ASSETS_BASE_B = "/fotoscatalogoweb/";
...
(function () {
  ...
  /* === Arranque (antes estaba en DOMContentLoaded) === */
  (async () => {
    try {
